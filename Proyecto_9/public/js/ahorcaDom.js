...
function imagenesDoom(){
  ...
  if(errores==1){
    imagen.src="../images/doomcabeza.jpg";
  }else if(errores==2){
    imagen.src="../images/doomizq.jpg";
  }else if(errores==3){
    imagen.src="../images/doomder.jpg";
  }else if(errores==4){
    imagen.src="../images/doomentero.jpg";
  }else if(errores==5){
    imagen.src="../images/gameover2.jpg";
  }
}
